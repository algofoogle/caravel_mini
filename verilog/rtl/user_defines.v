...
// Pins used for Caravel Mini project selection, configured as:
// - USER for input into the mux within the UPW
// - PULLUP so that only pins to be grounded need bonding (during packaging)
